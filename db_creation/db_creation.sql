...
START TRANSACTION;
USE `payicam_accueil`;
INSERT INTO `payicam_accueil`.`payicam_accueil_slide` (`slide_id`, `slide_image`, `slide_message`) VALUES (1, 'Banniere-PayIcam-Gala.png', DEFAULT);
INSERT INTO `payicam_accueil`.`payicam_accueil_slide` (`slide_id`, `slide_image`, `slide_message`) VALUES (2, 'bde-jungle-2.png', DEFAULT);
INSERT INTO `payicam_accueil`.`payicam_accueil_slide` (`slide_id`, `slide_image`, `slide_message`) VALUES (3, '370BE03A-626A-452D-B702-9EAB6AE585B0.png', DEFAULT);
