...
CREATE TABLE IF NOT EXISTS `payicam_accueil`.`payicam_accueil_slide` (
  ...
  `slide_message` VARCHAR(255) CHARACTER SET 'utf8' NOT NULL,
...
CREATE TABLE IF NOT EXISTS `payicam_accueil`.`payicam_carte` (
  ...
  `carte_lien` VARCHAR(255) NOT NULL,
...
START TRANSACTION;
USE `payicam_accueil`;
INSERT INTO `payicam_accueil`.`payicam_carte` (`carte_id`, `carte_titre`, `carte_description`, `carte_activation_bouton`, `carte_bouton`, `carte_photo`, `carte_lien`, `sites`) VALUES (1, 'Recharger', 'Le rechargement se fait via Casper, l\'interface web pour la gestion de son compte personnel ', 1, 'Rechargement', 'carte.png', 'casper', NULL);
INSERT INTO `payicam_accueil`.`payicam_carte` (`carte_id`, `carte_titre`, `carte_description`, `carte_activation_bouton`, `carte_bouton`, `carte_photo`, `carte_lien`, `sites`) VALUES (2, 'Billetteries', 'Nous avons maintenant deux billetteries ! Vous connaissez déjà Shotgun, utilisée pour de basiques évènements. Billetterie est utilisée pour des billetteries avancées comme le Gala ou le Spring', 1, 'Shotgun', 'ticket.png', 'shotgun', NULL);
INSERT INTO `payicam_accueil`.`payicam_carte` (`carte_id`, `carte_titre`, `carte_description`, `carte_activation_bouton`, `carte_bouton`, `carte_photo`, `carte_lien`, `sites`) VALUES (3, 'Gala Icam ', 'La vente de place pour l\'édition 2019 du gala est ouverte!', 1, 'Inscription', 'gala.png', 'billetterie', NULL);
INSERT INTO `payicam_accueil`.`payicam_carte` (`carte_id`, `carte_titre`, `carte_description`, `carte_activation_bouton`, `carte_bouton`, `carte_photo`, `carte_lien`, `sites`) VALUES (4, 'Réservations de sandwichs', 'Il est maintenant possible de réserver ses sandwichs pour la cafet par PayIcam !', 1, 'Réserver', 'sandwich.jpg', 'reservation_sandiwch', NULL);
