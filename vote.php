...
<body>
  ...
  <form action="a_voter.php" method="post"> 
    <div class="modal fade" id="choix_2Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="choix_2_label">Vote</h5>
  ...
  <form action="a_voter.php" method="post">
    <div class="modal fade" id="choix_1Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
