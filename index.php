...
<div id="carouselExampleIndicators" style="padding-top: 0px ; margin-bottom: 30px; border-radius: 4px;" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" style="height: 500px ;  width:auto; object-fit: contain">
    ...
    <div class="carousel-item" style="height: 500px; width:auto; object-fit: contain">
    ...
    <div class="carousel-item" >
      <img class="d-block w-100" id="slide3" src="img/slide3.jpg" style="height: 500px; width:auto; object-fit: contain"  alt="Third slide">
